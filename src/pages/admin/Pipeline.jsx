      ...
      <form className="crm-modal" onClick={(e) => e.stopPropagation()} onSubmit={handleSubmit}>
        <div className="crm-modal-body">
          ...
          <div className="field">
            ...
            <input id="d-title" type="text" value={form.title} onChange={(e) => setForm((f) => ({ ...f, title: e.target.value }))} placeholder="Ex: Pedido corporativo - clínica X" autoFocus />
          </div>
          <div className="field">
            <label htmlFor="d-customer">Cliente</label>
            <input id="d-customer" type="text" value={form.customerName} onChange={(e) => setForm((f) => ({ ...f, customerName: e.target.value }))} />
          </div>
